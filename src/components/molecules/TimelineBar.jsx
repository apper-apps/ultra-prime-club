...
const getBarColor = (edition) => {
    const colors = {
      ...
      'black': 'linear-gradient(135deg, #FEF08A 0%, #FACC15 100%)',
      'collector': 'linear-gradient(135deg, #86EFAC 0%, #22C55E 100%)',
      'limited': 'linear-gradient(135deg, #FCA5A5 0%, #EF4444 100%)'
    };
